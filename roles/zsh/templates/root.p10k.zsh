# Generated by Powerlevel10k configuration wizard on 2026-04-11 at 22:32 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%124F╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%124F├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%124F╰─'
  # Connect right prompt lines with these symbols.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%124F─╮'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%124F─┤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%124F─╯'
  ...
  # Default background color - darker red tint for root.
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color - red background for root visibility.
  ...
  ##################################[ dir: current directory ]##################################
  # Default current directory color - brighter for root.
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=217
  ...
  ##################################[ context: user@hostname ]##################################
  # Context color when running with privileges - bright red, bold.
  ...
  # Default context format: bold user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%B%n@%m'

  # Always show context for root - never hide it.
